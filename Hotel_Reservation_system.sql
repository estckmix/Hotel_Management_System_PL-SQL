-- ===========================================================================
-- NAME:        Hotel_Reservation_system.sql
-- CREATED:     02-JAN-2025
-- BY:          D. RADOICIC
-- VERSION:     2.0
-- DESCRIPTION: A comprehensive PL/SQL code for a Hotel Reservation System 
-- that manages room availability, guest information, and booking records. 
-- The code includes features for making reservations, checking guests in 
-- and out, and generating an occupancy report.
-- MODIFICATION HISTORY
-- DATE         AUTHOR              DESCRIPTION
-- -----------  ------------------  ---------------------------------------------
-- 03-JAN-2025  D. RADOICIC         Initial Version
-- ===============================================================================
...
CREATE TABLE rooms (
    ...
    is_available VARCHAR2(1) CHECK (is_available IN ('Y', 'N'))
);
...
CREATE TABLE guests (
    ...
    contact_number VARCHAR2(15) CHECK (REGEXP_LIKE(contact_number, '^[0-9]+$'))
);
...
-- Step 2: Create sequences for booking and guest IDs
...
BEGIN
    -- Ensure the booking exists and is not already checked in
    DECLARE
        v_count NUMBER;
    BEGIN
